...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <h2>Lista de Renders Residenciales</h2>
            <p style="text-align: center; font-size: 1.1rem;">Aquí encontrarás una selección de nuestros Renders Residenciales.</p>
